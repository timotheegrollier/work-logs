...
- **`./scripts/check.sh` vert avant et après.** Il enchaîne types, 81 tests API, 78 tests front,
  28 tests serveur desktop/OAuth/mise à jour, 16 tests des scripts de release, build,
  20 parcours navigateur et 6 parcours de l'application desktop — **229 tests**,
...
./scripts/check.sh   # tout, 229 tests
